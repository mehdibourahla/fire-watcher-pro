...
- [ ] **P7 Broadcasts.** Kill switch behind a confirm plus reason, delivery channels moved in, relay dialog through the RPC, readable audit.
- [ ] **P8 Risk, DGPC incidents, Places.** States, reasons, location, search, pagination.

...
| A-10 | Targeted dependency overrides produce a clean `bun audit --json`. Hosted leaked-password protection still requires the owner's Supabase dashboard sign-in; no plan upgrade or configuration change was made. |

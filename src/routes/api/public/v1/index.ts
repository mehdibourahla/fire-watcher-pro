    ...
    handlers: {
      ...
      GET: async ({ request }) => {
        ...
        return json({
          ...
          notes: "Read-only. Responses are cached for 60 seconds. Please stay under 60 requests per minute.",
          endpoints: [
            {
              path: "/api/public/v1/fires",
              params: { state: "optional", since: "optional ISO timestamp", limit: "1-500", offset: "integer" },
              example: `${base}/api/public/v1/fires?state=active&limit=50`,
            },
            {
              path: "/api/public/v1/risk",
              params: { horizon: "0-5", commune: "optional commune code", limit: "1-1000", offset: "integer" },

...
export function buildContentSecurityPolicy(
  ...
  return [
    ...
    `img-src 'self' data: blob: https://*.cartocdn.com https://view.eumetsat.int${storageSource}`,
    `connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.cartocdn.com https://view.eumetsat.int https://firebaseinstallations.googleapis.com https://fcmregistrations.googleapis.com https://air-quality-api.open-meteo.com${storageSource}${localSupabase}`,

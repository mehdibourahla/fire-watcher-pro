export const en = {
  authKit: {
    localSignedOut:
      "Signed out on this device. Other sessions may still be active.",
    signinTitle: "Welcome back",
    signinBody: "Sign in to manage your zones, alerts and account.",
    signupTitle: "Create your account",
    signupBody: "Keep your alert preferences and followed zones together.",
    forgotTitle: "Forgot your password?",
    forgotBody:
      "Enter your email and we’ll send you a link to choose a new password.",
    resetTitle: "Choose a new password",
    resetBody: "Use a strong password you don’t use elsewhere.",
    verifyTitle: "Verify your email",
    verifyBody: "Enter your signup email to request another confirmation link.",
    signinAction: "Sign in",
    signupAction: "Create account",
    forgotAction: "Send reset link",
    resetAction: "Save new password",
    verifyAction: "Send confirmation link",
    passwordUpdated: "Password updated",
    passwordUpdatedBody:
      "Your new password is ready. You can continue to your account.",
    checkEmail: "Check your email",
    checkEmailBody:
      "If this address is eligible, you’ll receive an email with the next step.",
    emailHint:
      "Check your spam folder too. Open the link in this browser to complete the request.",
    ...
    passwordHint: "At least 8 characters. A unique passphrase works well.",
    ...
    linkInvalid:
      "This link is invalid, expired or already used. Request a fresh link and open it in the same browser.",
    signedIn: "Signed in",
    ...
    passwordSecurityHint:
      "To set or change your password, request a secure link sent to your email.",
  ...
  civilMap: {
    ...
    sourceTime: "Event timestamps appear on each report.",
    title: "Around you",
    national: "Across Algeria",
    search: "Search a commune or wilaya",
    allAreas: "All areas",
    locate: "Use my location",
    locationDenied: "Location unavailable. Choose a commune or wilaya.",
    outsideCoverage: "This location is outside coverage in Algeria.",
    searchEmpty: "No matching commune or wilaya",
    all: "All",
    fire: "Fire",
    weather: "Weather",
    road: "Road",
    ...
    limited: "Some sources are delayed or unavailable",
    ...
    follow: "Receive area alerts",
    following: "Area alerts enabled",
    communeOnly: "Choose a commune to receive area alerts",
    ...
    showLightning: "Lightning (last 10 minutes)",
    showCandidates: "Include unverified observations",
    source: "Source",
    observedAt: "Observed",
    validUntil: "Valid until",
    areaPrecision:
      "Area-level information. The marker shows the area centre, not the exact incident location.",
    nearbyScope:
      "Citizen reports within {{km}} km of a commune centre are nearby reports, not verified administrative matches.",
    openSource: "Open source",
    openDetail: "View details",
    share: "Share",
    copied: "Link copied",
    shareFailed: "Unable to share this link",
    help: "Help",
    fireHelp: "Immediate fire danger",
    forecast: "Weather forecast",
    selectCommuneWeather: "Choose a commune to see its forecast",
    ...
    lightningLegend:
      "Lightning shows where EUMETSAT's MTG Lightning Imager saw flashes in its latest 10-minute window, a few minutes behind real time. It is an observation, not a warning.",
    ...
    unsavePlace: "Remove saved place",
    savedUnavailable: "Saved places are unavailable on this device",
    issuedAt: "Issued",
    technical: "Technical details",
    mapTitle: "Hazards and warnings around you",
    filters: "Filters",
    nearby: "Nearby",
  ...
  fire: {
    ...
    seenBetween: "First seen {{first}}, last seen {{ago}}.",
    insideZone: "Inside your zone {{name}}.",
    share: "Share",
    linkCopied: "Link copied",
    reportHere: "Report what you see",
    conditions: "Conditions at the fire",
  ...
  status: {
    ...
    note: "Note",
    validAge: "Valid data {{time}}",
    noValidData: "No valid data yet",
    lastSuccessAt: "Last validated {{time}}",
    neverValidated: "Never validated",
    coverage: "Coverage {{accepted}} / {{expected}}",
    ...
    reason: {
      ...
      coverage_partial: "Only part of the expected coverage was validated",
      dependency_failed: "A required processing dependency failed",
      delivery_failed: "One or more delivery attempts failed",
      disabled: "Paused by an operator",
      internal_error: "The latest run failed internally",
    },
  },
  about: {
  ...
  account: {
    ...
    zoneNowSandstorm: "Sandstorm measured at {{airport}}, visibility {{m}} m",
    zoneNothingNow:
  ...
  station: {
    eyebrow: "Airport weather report",
    sandstorm: "Sandstorm measured at {{airport}}",
    visibility: "Visibility {{m}} m",
    visibilityLabel: "Visibility",
    metres: "{{m}} m",
    observed: "Observed",
    wind: "Wind",
    windKt: "{{kt}} kt",
    windGusts: "{{kt}} kt, gusts {{gust}} kt",
    note: "Measured at the airport and relayed by the NOAA Aviation Weather Center. A measurement, not a forecast or a warning.",
  },
  quake: {
  ...
  reports: {
    ...
    metaTitle: "Report a hazard · Nadhir",
    metaDescription:
      "Tell people nearby what you see: fire, flooding, storm damage, a blocked road. Witnesses confirm it on the map.",
    subtitle:
      "Seen something dangerous? Three taps put it on the map for people nearby.",
    start: "Report what you see",
    stepWhat: "What do you see?",
    stepWhere: "Where is it?",
    stepDetails: "Anything to add?",
    tile: {
      sighting: "Fire or smoke",
      flooding: "Flooding",
      storm_damage: "Storm damage",
      road_blocked: "Road blocked",
      earthquake: "Earthquake damage",
    ...
    whereHint: "Move the map until the pin sits on the danger.",
    locationError:
      "Your location is unavailable. Move the map to the place instead.",
    confirmPlace: "The pin is on the place",
    back: "Back",
    notePlaceholder: "Landmarks, road, what is happening…",
    noteRequired: "Describe what you see in a few words.",
    sentPublished: "Your report is on the map",
    sentChecking: "We are checking your report",
    sentCheckingBody:
      "It appears on the map as soon as the check passes, usually within a minute.",
    sentHeld: "A moderator will read your report before it appears.",
    sentHow:
      "When someone nearby taps “I see it too”, your report is confirmed and alerts people who follow this area.",
    sentPoints: "You earn 10 points when someone confirms it.",
    another: "Report something else",
    done: "Done",
    sosTitle: "Call 14 first",
    sosBody:
      "Civil Protection carries out rescues. Nadhir records where the person is, but nobody watches it in real time.",
    sosCall: "Call 14",
    sosRecord: "Record where they are",
    sosPrivate: "This report stays private and never appears on the map.",
    level: {
      observer: "Observer",
      witness: "Witness",
      guardian: "Guardian",
    ...
    badge: {
      ...
      fiveConfirmations: "Five confirmations given",
      threeHazards: "Three kinds of hazard",
      alertedPeople: "Alerted your neighbours",
    },
    ...
    dailyLimit:
      "You have sent 3 reports in the last 24 hours. Try again later.",
    witnessSeen: "I see it too",
    witnessGone: "It’s gone",
    witnessThanks: "Thank you. Your confirmation counts.",
    witnessGoneThanks: "Thank you. A moderator will check it.",
    witnessTooFar: "You need to be within 5 km to answer.",
    witnessOwn: "This is your own report.",
    witnessClosed: "This report is no longer open.",
    witnessRateLimited: "Too many answers for now. Try again later.",
    witnessFailed: "Your answer could not be recorded. Try again.",
    witnessLocate: "Allow your location to answer.",
    witnessSignIn: "Sign in to confirm what you see",
    citizenLabel: "Citizen report, not verified by authorities",
    reportButton: "Report",
  },
  contribute: {
    statFuelSubDone:

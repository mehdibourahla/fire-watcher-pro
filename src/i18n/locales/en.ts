export const en = {
  ...
  explain: {
    ...
    fwiPercentile:
      "Today's Fire Weather Index compared with this commune's own history on this calendar day, over 86 years. A place that is always extreme in summer can still be at its own historical ceiling — this is what discriminates that.",
    dangerLevel:
  ...
  risk: {
    ...
    today: "Today",
    fwi: "FWI",
    percentile: "hotter than {{pct}}% of years on this date",
    level: "Danger level",

...
Production Google OAuth and Resend SMTP remain pending owner setup. The owner created Google branding; the OAuth client form now awaits credential-creation approval. Resend sign-in is awaiting completion. No production auth settings were changed during this milestone.
